...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Cơ sở dữ liệu số hóa 2.436+ loài sinh vật biển Việt Nam — Hệ thống tra cứu danh pháp, hình thái học & sinh thái. Một dự án được phát triển bởi haitrinh.',
...
const websiteSchema = {
  ...
  url: SITE_URL,
  description: 'Cơ sở dữ liệu số hóa 2.436+ loài sinh vật biển Việt Nam phục vụ học tập, nghiên cứu và cộng đồng — Một dự án được phát triển bởi haitrinh.',
  author: {
    '@type': 'Person',
    name: 'haitrinh',
    url: SITE_URL,
