...
export default function SpeciesForm({ initial, collection, onSave, onClose }: Props) {
  ...
  const [form, setForm] = useState<Record<string, string>>({
    ...
    morphology_vn:      initial?.morphology_vn || '',
    morphology_en:      initial?.morphology_en || '',
    ecology_vn:         initial?.ecology_vn || '',
    ecology_en:         initial?.ecology_en || '',
    economic_value_vn:  initial?.economic_value_vn || '',
    economic_value_en:  initial?.economic_value_en || '',
