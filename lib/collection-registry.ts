...
export const REGISTRY: Record<string, CollectionDef> = {
  ...
  'bo-sat-bien': {
    ...
    slug: 'bo-sat-bien',
    nameVn: 'Bò sát biển',
    nameEn: 'Marine Reptiles of Vietnam',
    icon: '🐢',
    accentColor: '#f59e0b',
    volumeCount: 3,
    status: 'active',
    ...
    books: [
      ...
      {
        id: 'rua-bien-viet-nam',
        title: 'Bảo tồn Rùa biển Việt Nam',
        badge: 'Tập II (5 loài)',
        author: 'Bộ NN&PTNT, Viện TN&MT Biển (VAST), IUCN Việt Nam',
        publisher: 'NXB Nông nghiệp — Kế hoạch Hành động Quốc gia',
        yearRange: '2016 – 2024',
        totalSpecies: 5,
        description: 'Tổng điều tra hiện trạng, bãi đẻ, độc tố học thức ăn và kế hoạch hành động bảo tồn 5 loài Rùa biển (Cheloniidae & Dermochelyidae) tại các vùng biển Việt Nam.',
        volumes: [
          {
            volume: 2,
            roman: 'II',
            year: '2016–2024',
            title: 'Rùa biển Việt Nam (Marine Turtles of Vietnam)',
            subTitle: 'Phân loại học, bãi đẻ Côn Đảo - Núi Chúa và kế hoạch hành động bảo tồn quốc gia',
            author: 'Bộ NN&PTNT & Nhóm Chuyên gia Bò sát biển VAST/IUCN',
            speciesCount: 5,
          },
        ],
      },
      {
        id: 'ca-sau-hoa-ca',
        title: 'Cá sấu hoa cà Việt Nam',
        badge: 'Tập III (1 loài)',
        author: 'Viện Sinh thái và Tài nguyên Sinh vật (VAST)',
        publisher: 'Sách Đỏ Việt Nam — Động vật chí Việt Nam',
        yearRange: 'Chuyên khảo',
        totalSpecies: 1,
        description: 'Hồ sơ phân loại học, dẫn liệu lịch sử phân bố tại rừng ngập mặn Cần Giờ, Côn Đảo, Cà Mau và tình trạng bảo tồn cực kỳ nguy cấp của loài Bò sát biển lớn nhất hành tinh.',
        volumes: [
          {
            volume: 3,
            roman: 'III',
            year: '',
            title: 'Cá sấu hoa cà / Cá sấu nước mặn (Saltwater Crocodile)',
            subTitle: 'Dẫn liệu lịch sử rừng ngập mặn Nam Bộ và hồ sơ bảo tồn Sách Đỏ',
            author: 'GS. Đặng Ngọc Thanh, TS. Nguyễn Văn Sáng & CS',
            speciesCount: 1,
          },
        ],
      },
  ...
  'than-mem': {
    ...
    books: [
      ...
      {
        id: 'bivalvia-kinh-te-bien-2015',
        title: 'Lớp thân mềm hai mảnh vỏ (Bivalvia) kinh tế biển Việt Nam',
        badge: 'Chuyên khảo Bivalvia (100+ loài)',
        author: 'PGS.TS. Đỗ Công Thung (Chủ biên)',
        publisher: 'NXB Khoa học tự nhiên và Công nghệ',
        yearRange: '2015',
        totalSpecies: 100,
        description: 'Chuyên khảo nghiên cứu phân loại hình thái, sinh thái học, phân bố và giá trị kinh tế của các loài thân mềm hai mảnh vỏ (Sò, Nghêu, Hàu, Điệp, Tu hài...) tại các vùng biển Việt Nam.',
        volumes: [
          {
            volume: 2,
            roman: '2',
            year: '2015',
            title: 'Hai mảnh vỏ (Bivalvia) kinh tế',
            subTitle: 'Hình thái vỏ, sinh thái, phân bố và giá trị sử dụng',
            author: 'Đỗ Công Thung và cs.',
            speciesCount: 100,
          },
        ],
      },
    ...
    books: [
      {
        ...
        yearRange: '2016 – 2019',
        totalSpecies: 101,
        description: 'Tập hợp ảnh mẫu vi thể hiển vi độ nét cao và hồ sơ phân loại học, sinh học - sinh thái, phân bố địa lý của 101 loài Giáp xác chân chèo (Copepoda) thu thập tại các vùng biển Việt Nam, lưu trữ mẫu vật tại Viện Hải dương học.',
        volumes: [
          {
            volume: 1,
            roman: 'I',
            ...
            subTitle: 'Phân loại học, sinh học - sinh thái, phân bố và mẫu vật nghiên cứu Viện Hải dương học',
            author: 'TS. Trương Sĩ Hải Trình & CS',
            speciesCount: 101,
          },
        ],
