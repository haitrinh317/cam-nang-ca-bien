"""
Patch 3 seaweed species in Supabase with complete bilingual AlgaeBase data:
- depth & depthVn
- habitat & habitatVn
- importance & importanceVn
- biologySummary (EN) & biologySummaryVn (VN)
"""
...
DATA = {
    'thucvat-species-1': {
        ...
        'depth': '0 - 15 m',
        'depthVn': '0 - 15 m',
        'habitat': 'Subtidal zone, attached to rocks, gravel, and dead coral substrates',
        'habitatVn': 'Đới dưới triều nông, mọc bám trên đá, sỏi và nền san hô chết',
        'importance': 'Commercial harvest for human food and high-grade agar extraction',
        'importanceVn': 'Khai thác tự nhiên làm thực phẩm và chiết xuất thạch agar chất lượng cao',
    ...
    'thucvat-species-2': {
        ...
        'depth': '0.5 - 5 m',
        'depthVn': '0,5 - 5 m',
        'habitat': 'Low intertidal to upper subtidal zone on rocky reefs and coral substrates',
        'habitatVn': 'Vùng triều thấp và đới dưới triều nông trên rạn đá và nền san hô',
        'importance': 'Wild harvest for food and raw material for agar production',
        'importanceVn': 'Khai thác tự nhiên làm thực phẩm và nguyên liệu chế biến thạch agar',
    ...
    'thucvat-species-3': {
        ...
        'depth': '0 - 3 m',
        'depthVn': '0 - 3 m',
        'habitat': 'Outer reef crests and rocky intertidal areas exposed to strong wave action',
        'habitatVn': 'Gờ rạn san hô ngoài và vùng triều đá nơi có sóng vỗ đập dữ dội',
        'importance': 'Prized local culinary specialty (rau cau chan vit), rich in dietary minerals and fiber',
        'importanceVn': 'Đặc sản ẩm thực giá trị cao (chè rau câu chân vịt Lý Sơn, gỏi rong sụn), giàu khoáng chất và chất xơ',
...
print('Done updating pristine bilingual biology data in Supabase!')
