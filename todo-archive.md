...
> Cập nhật: 2026-09-16
> **Supabase (SSOT):** 2,971 loài (8 collection) | **Production:** https://www.tracuusinhvatbien.app

## ✅ Hoàn thành (2026-09-15)
...
- [x] **Khôi phục Logo Cá nhân (Sóng biển & Vây cá tuần hoàn)**:
  ...
  - Đồng bộ nhận diện thương hiệu toàn diện: `logo.png`, `favicon.ico`, `icon-192x192.png`, `icon-512x512.png`.
